...
contract loans {
    ...
    uint256 internal lastLoanIdNo = 0;
    ...
    function newLender( string name ) public returns address {
        require (lenderName[msg.sender] == "")
        lenderName[msg.sender] = name;
        return msg.sender;
    }
    
    function changeLenderName( string name ) public only_owner returns bool {
        require (lenderName[msg.sender] != "")
        lenderName[msg.sender] = name;
        return true;
    }
    ...
    function offerLoan( loan offer ) public returns address {
        require (lenderName[msg.sender] == "")
        require ();
        require ();
        require ();
    ...
    function withdrawOfferedLoan( loan newLoan ) public returns address {
        require (lenderName[msg.sender] == "")
        require ();
        require ();
        require ();
    ...
    function acceptLoan( loan newLoan) public returns address {
        require (lenderName[msg.sender] == "")
        require ();
        require ();
        require ();
    ...
    function makeRepayment() public returns bool {
        
    }
    
    
    function updateHistory() internal returns bool {
        
    }
    
    
    function refundMistake()internal returns bool {
    ...
    event IdentifyLender(address indexed from, address indexed to, uint256 value);
    
    /* This generates a public event on the blockchain that will notify clients */
    event ChangeLenderName(address indexed from, address indexed to, uint256 value);
